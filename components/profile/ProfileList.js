            ...
            <Grid key={index} item xs={4}>
              <Card variant="outlined">
                {profile.account ? (
                  <>
                    <CardContent>
                      <Avatar sx={{ width: 82, height: 82, mb: 2 }} src={profile.avatarNftMetadata?.profilePicture}>
                        <InsertPhotoOutlined />
                      </Avatar>
                      <Typography variant="h4" sx={{ mb: 2 }}>{profile.avatarNftMetadata?.publicProfile?.firstName || "None"} {profile.avatarNftMetadata?.publicProfile?.lastName || "None"}</Typography>
