...
/**
 * A component for input profile attributes (traits).
 */
      ...
      setAttributes([
        {
          ...
          value: propsAttributes.find(attribute => attribute?.trait_type === traitTypes.firstName)?.value || ""
        },
        {
          trait_type: traitTypes.lastName,
          value: propsAttributes.find(attribute => attribute?.trait_type === traitTypes.lastName)?.value || ""
        },
        {
          trait_type: traitTypes.email,
          value: propsAttributes.find(attribute => attribute?.trait_type === traitTypes.email)?.value || ""
        },
        {
          trait_type: traitTypes.twitter,
          value: propsAttributes.find(attribute => attribute?.trait_type === traitTypes.twitter)?.value || ""
        },
      ]);
    }
        ...
        <>
          ...
          <Stack spacing={1} sx={{ mb: 4 }}>
            <TextField
              ...
              value={attributes.find(attribute => attribute?.trait_type === traitTypes.firstName)?.value} />
            <TextField
              variant="outlined"
              onChange={onChange}
              ...
              disabled={propsDisabled}
              value={attributes.find(attribute => attribute?.trait_type === traitTypes.lastName)?.value} />
          </Stack>
          ...
          <Stack spacing={1} sx={{ mb: 4 }}>
            <TextField
              ...
              disabled={propsDisabled}
              value={attributes.find(attribute => attribute?.trait_type === traitTypes.email)?.value} />
          </Stack>
          ...
          <Stack spacing={1} sx={{ mb: 2 }}>
            <TextField
              ...
              disabled={propsDisabled}
              value={attributes.find(attribute => attribute?.trait_type === traitTypes.twitter)?.value} />
          </Stack>
        </>
      ) : (
        <></>
